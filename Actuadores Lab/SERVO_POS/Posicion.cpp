...
int main(void)
		...
		while(1){
			...
			switch(cadena){
				...
				case 1:{
					GPIOD->BSRR |= 0xFFFE0001;
					break;
				}
				case 2:{
					GPIOD->BSRR |= 0xFFFD0002;
					break;
				}
				case 3:{
					GPIOD->BSRR |= 0xFFFC0003;
					break;
				}
				case 4:{
					GPIOD->BSRR |= 0xFFFB0004;
					break;
				}
				case 5:{
					GPIOD->BSRR |= 0xFFFA0005;
					break;
				}
				case 6:{
					GPIOD->BSRR |= 0xFFF90006;
					break;
				}
				case 7:{
					GPIOD->BSRR |= 0xFFF80007;
					break;
				}
		}
...
void IN_ADC(){ // funcion entrada As  DC
...
valor_DAC = abs(VV * 1.36); // conversion de DAC a voltaje correspondiente
